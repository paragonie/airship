...
CREATE INDEX  IF NOT EXISTS airship_tree_updates (channel);
CREATE INDEX  IF NOT EXISTS airship_tree_updates (channelupdateid);
CREATE UNIQUE INDEX  IF NOT EXISTS airship_tree_updates (channel, channelupdateid);
CREATE INDEX  IF NOT EXISTS airship_tree_updates (merkleroot);
